...
async function mintandList() {
    ...
    const badgeId = mintTxReceipt.events[1].args.badgeId; // event[0] is the transfer event generated by _safeMint from event Transfer(address indexed from, address indexed to, uint256 indexed tokenId) in IERC721.sol
